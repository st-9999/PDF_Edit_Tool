...
- [ ] T3 不足文字: 同一書体の別フォントリソース → 同梱フォント（fontkit＋Noto Sans JP サブセット）での補完と警告
- [ ] T4 UI: テキスト編集モード、範囲選択、入力、揃え切替、プレビュー、Undo/Redo、保存・抽出・分割への反映、E2E
- [ ] 画像編集（追加・差し替え・削除）— 後回し
